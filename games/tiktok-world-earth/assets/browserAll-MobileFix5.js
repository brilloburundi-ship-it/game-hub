import { X as Ticker, Y as UPDATE_PRIORITY, Z as Point, _ as removeItems, D as ExtensionType, E as EventEmitter, w as warn, W as extensions, $ as Container } from './index-V104FantasyRTS.js?build=7';
import './webworkerAll-C_tVFJiX.js?build=7';
...
class EventBoundary {
  ...
  hitTestMoveRecursive(currentTarget, eventMode, location, testFn, pruneFn, ignore = false) {
    ...
    if (currentTarget.interactiveChildren && currentTarget.children) {
      ...
      for (let i = children.length - 1; i >= 0; i--) {
        ...
        if (nestedHit) {
          ...
          const isInteractive = typeof currentTarget.isInteractive === "function" ? currentTarget.isInteractive() : this._isInteractive(currentTarget.eventMode ?? eventMode);
    ...
    const isInteractiveTarget = typeof currentTarget.isInteractive === "function" ? currentTarget.isInteractive() : this._isInteractive(currentTarget.eventMode ?? eventMode);
   ...
   */
  notifyTarget(e, type) {
    if (typeof e.currentTarget.isInteractive === "function" ? !e.currentTarget.isInteractive() : !this._isInteractive(e.currentTarget.eventMode)) {
      return;
    }
    type ?? (type = e.type);
