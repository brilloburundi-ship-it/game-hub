(() => {
  ...
  async function install() {
    ...
    // V8 invokes housekeeping from the single simulation clock. Keeping cleanup
    // out of Pixi's frame loop prevents its cost from scaling with rendered FPS.
    sim.__v70Housekeeping = housekeeping;
    ...
    window.__V70_WAR_PEACE_CLEANUP = {
      ...
      housekeepingOwnedBySimulationClock: true
    };
