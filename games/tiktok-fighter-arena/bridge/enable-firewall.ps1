...
if (-not $existing) {
    ...
    Write-Host 'Porta 8795 abilitata sulle reti private per Fighter Arena.' -ForegroundColor Green
} else {
    Write-Host 'La regola privata per Fighter Arena sulla porta 8795 esiste gia.' -ForegroundColor Green
}
