...
const GIFT_TIER_2=['fantasy_warrior','street_mon','samurai','samurai_commander','medieval_warrior_3','evil_wizard_2'];
const GIFT_TIER_3=['martial_hero','samurai_archer','wanderer_magician','lightning_mage'];
