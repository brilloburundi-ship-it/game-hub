...
for(const name of [
  'game-v14.js','core.js','core-r18.js','combat-v14.js','arena-hd.js','idle-wait.js',
...
console.log(`Fighter Arena ${version.version}: 20/20 roster contract, shared v1.4 core, fail-safe render loop, full KO/death gate, verified Medieval Warrior WebP payloads, ${manifest.arenas.length} Retina HD arenas and LIVE/demo isolation OK.`);
